...
int main(int argc, char * argv[]) {
  ...
  */
  ...
  hp2p.SetDeviceAttribute("DataRate", DataRateValue(DataRate(bwt[0].first)));
  hp2p.SetDeviceAttribute("Mtu", UintegerValue(1522));
  hp2p.SetChannelAttribute("Delay", StringValue(delay));
  hp2p.SetQueue ("ns3::DropTailQueue", "MaxSize", StringValue ("1p"));

  TopoHelper::Connect(hp2p, 2, 3);
  
  InternetStackHelper stack;
  stack.Install(TopoHelper::allNodes);

  Config::SetDefault ("ns3::RedQueueDisc::MaxSize", StringValue (q_size.c_str()));
  Config::SetDefault ("ns3::RedQueueDisc::MeanPktSize", UintegerValue (588));
  Config::SetDefault ("ns3::RedQueueDisc::Wait", BooleanValue (true));
  Config::SetDefault ("ns3::RedQueueDisc::Gentle", BooleanValue (true));
  Config::SetDefault ("ns3::RedQueueDisc::QW", DoubleValue (0.002));
  Config::SetDefault ("ns3::RedQueueDisc::MinTh", DoubleValue (20 * 588));
  Config::SetDefault ("ns3::RedQueueDisc::MaxTh", DoubleValue (100 * 588));
