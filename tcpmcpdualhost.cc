...
int main(int argc, char * argv[]) {
  ...
  TopoHelper::AssignIP(address, 4, 2);
  ...
  source.SetAttribute ("MaxBytes", UintegerValue(max_bytes/2));
  ...
  ApplicationContainer sourceApp2 = source.Install(TopoHelper::allNodes.Get(4));
  sourceApp2.Start (MicroSeconds(1000000.0 + bwt[0].second));
